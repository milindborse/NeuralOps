...
const SIM_SCENARIOS = {
  birthday_hot_none: [
    ...
    { agent: "⬆️ Agent 8: Upsell", desc: "Presenting: Birthday Premium Package (+₹1200). Customer responds positively.", status: "ok", conf: 82, delay: 700 },
  ...
  birthday_warm_none: [
    ...
    { agent: "🛡️ Agent 7: Objection Intelligence", desc: "Objection detected: 'need to check with friends'. Classification: social approval barrier.", status: "ok", conf: 76, delay: 500 },
    ...
    { agent: "⏱️ Agent 16: Callback Optimizer", desc: "Analyzing engagement patterns. Optimal callback window: Tomorrow 11am–1pm.", status: "ok", conf: 71, delay: 400 },
  ...
  complaint_hot_none: [
    ...
    { agent: "⚠️ Agent 4: Conflict Predictor", desc: "Escalation risk score: 91/100. Immediate routing change required.", status: "warn", conf: 91, delay: 400 },
  ...
  abandoned_hot_none: [
    ...
    { agent: "⏱️ Agent 16: Callback Optimizer", desc: "Optimal re-engagement: 45 minutes post-abandonment.", status: "ok", conf: 70, delay: 400 },
